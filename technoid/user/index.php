...
<div class="row bg-light my-5 p-3" style="margin: 0 -50px">
    <div class="col">
        ...
        <div class="d-flex w-100">
            <img class="w-100" src="<?= url ?>assets/images/pages/aban1.jpg" alt="">
            <img class="w-100" src="<?= url ?>assets/images/pages/aban3.png" alt="">
            <img class="w-100" src="<?= url ?>assets/images/pages/aban2.jpg" alt="">
            <img class="w-100" src="<?= url ?>assets/images/pages/aban4.png" alt="">
        </div>
    </div>
</div>
